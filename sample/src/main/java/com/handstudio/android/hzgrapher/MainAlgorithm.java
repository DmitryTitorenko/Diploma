...
public class MainAlgorithm extends Activity {
    ...
    public void mainAlgorithmBegin() {
        ...
        float specificHeatC = Integer.valueOf(extras.getString(Saving.specificHeatC));
        float heatProductivityN = Integer.valueOf(extras.getString(Saving.heatProductivityN));
        float coolingProductivityN = Integer.valueOf(extras.getString(Saving.coolingProductivityN));
        float coefficientN = Integer.valueOf(extras.getString(Saving.coefficientN));
        float r0 = Integer.valueOf(extras.getString(Saving.r0));
        float heatLossExtraB = Integer.valueOf(extras.getString(Saving.heatLossExtraB));
